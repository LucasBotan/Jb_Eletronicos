...
namespace CRMagazine
{
    public partial class frmEntradaDeNotas : Form
    {
        ...
        public void LerXML(string NS, int Cont, string nome)
        {
            ...
            consultar.comando = "";
            consultar.comando = "select NotaFiscal as Quantidade from NotaFiscal where NotaFiscal = '" + txtNota.Text + "' and Varejista = '" + cboVarejista.Text + "'";
