...
namespace CRMagazine
{
    public partial class frmEstoqueEntrada : Form
    {
        ...
        public void Concluir(string Cod, string Descricao, string Quantidade, string Barebone)
        {
            ...
            consultar.comando = "";
            consultar.comando += "Select * from Estoque where Codigo = '" + Cod + "' and Posicao = '" + posicao + "'";
            ...
            if (consultar.Retorno == "ok")
            {
                ...
                consultar.comando = "";
                consultar.comando = "update Estoque set Quantidade = '" + total + "' where Posicao = '" + posicao + "' and Codigo = '" + Cod + "'";
                consultar.Atualizar();
            }
             else
             {
                ...
                {
                    sql = "";
                    sql += " Insert into Estoque (Codigo, Barebone, Descricao, Quantidade, Posicao)";
                    sql += " Values ( ";
                    sql += " '" + Cod + "', ";
                    sql += " '" + Barebone + "', ";
                    sql += " '" + Descricao + "', ";
        ...
        public void ConcluirComChamado(string Cod, string Descricao, string Barebone, string OS)
        {
            ...
            {
                sql = "";
                sql += " Insert into Estoque (Codigo, Barebone, Descricao, Quantidade, Posicao, Chamado)";
                sql += " Values ( ";
                sql += " '" + Cod + "', ";
                sql += " '" + Barebone + "', ";
                sql += " '" + Descricao + "', ";
                ...
                {                    
                    ...
                    {                        
                        ...
                        if (RetornoCodigo == "ok" && RetornoQuantidade == "ok")
                        {
                            ...
                            consultar.comando = "";
                            consultar.comando += "select count(*) as Quantidade from AguardoBackup WHERE Codigo = '" + Cod + "' AND Status = 'PENDENTE'";
                            consultar.consultarSimNao();
                    ...
                    while (dr2.Read())
                    {
                        if (Qnt > 0) // SE AINDA TEM QUANTIDADE, FAZ O PROCESSO
                        {
                            ...
                            if (consultar.Status == "PP") //VERIFICA O STATUS DO POSSIVEL AGUARDO DE BACKUP
                            {
                                ...
                                consultar.comando = "";
                                consultar.comando = "update AguardoBackup set Status = 'RECEBIDO' where idAguardoBackup = '" + id + "'";
                                consultar.Atualizar();
                            ...
                            else // NÃO PÕE NO ESTOQUE E ALTERA O STATUS DO AGUARDOBACKUP PARA CANCELADO
                            {
                                // =====================================
                                consultar.comando = "";
                                consultar.comando = "update AguardoBackup set Status = 'CANCELADO' where idAguardoBackup = '" + id + "'";
                                consultar.Atualizar();
                                // =====================================
                            }
                        }
