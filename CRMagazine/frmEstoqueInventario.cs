...
namespace CRMagazine
{
    public partial class frmEstoqueInventario : Form
    {
        ...
        {
            string sql = "";
            sql += " Select idCod, Codigo, Descricao, Quantidade, Posicao From Estoque where Codigo = '" + txtCodigo.Text + "'";
            cx.Conectar();
        ...
        private void btnConcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                consulta.comando = "";
                consulta.comando = "update Estoque set Quantidade = '" + txtNovaQuantidade.Text + "' where idCod = '" + txtID.Text + "'";
                consulta.Atualizar();
