...
namespace CRMagazine
{
    ...
    {
        public frmProcessosEnderecamento(string texto, string Chamado)
        {
            InitializeComponent();
        ...
        public void ListarLocais()
        {
            ...
            string sql = "";
            sql += " Select Local from Locais where Status = '" + txtStatus.Text + "'";
            cx.Conectar();
        ...
        {
            consulta.comando = "";
            consulta.comando += "update Chamados set LocalDeGuarda = '" + cbxLocalEnderecamento.Text + "' where OS = '" + txtOS.Text + "'";
            consulta.Atualizar();
