    ...
    public partial class frmEstoqueMovimentacao : Form
    {
      ...
      //  public string Barebone = "";
        ...
        public void ListarPosicaoes()
        {
            ...
            string sql = "";
            sql += " Select Distinct Posicao from Estoque";
            cx.Conectar();
        ...
        {
            string sql = "";
            sql += " Select idCod, Codigo, Descricao, Quantidade, Posicao from Estoque where Posicao = '" + cbxPosicao.Text + "' and Quantidade > 0";
            cx.Conectar();
        ...
        {
            string sql = "";
            sql += " Select idCod, Codigo, Descricao, Quantidade, Posicao from Estoque where Posicao = '" + cbxPosicao.Text + "' and Codigo = '" + txtConsultaCodigo.Text + "' and Quantidade > 0";
            cx.Conectar();
            SqlDataAdapter da = new SqlDataAdapter(sql, cx.c);
            DataSet ds = new DataSet();
            da.Fill(ds, "Estoque");
        ...
        {
            string sql = "";
            sql += " select idCod, Codigo, Descricao, Quantidade, Posicao from Estoque where Codigo = '" + codigo + "' and Posicao != '" + Posicao + "' and Posicao != 'PP'";
            cx.Conectar();
            SqlDataAdapter da = new SqlDataAdapter(sql, cx.c);
            DataSet ds = new DataSet();
            da.Fill(ds, "Estoque");
        ...
        {
            consulta.comando = "";
            consulta.comando = "Insert into Estoque (Codigo, Descricao, Quantidade, Posicao) Values (";
