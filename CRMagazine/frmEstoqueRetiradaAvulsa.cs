...
namespace CRMagazine
{
    ...
    {
        public frmEstoqueRetiradaAvulsa()//string Cod, string Usuario, string Quantidade, string ID, string Chamado)
        {
            InitializeComponent();
            /*
            txtCodPeca.Text = Cod;
        ...
        public void ListarUsuarios()
        {
            ...
            string sql = "";
            sql += " Select Usuario from Usuarios where Reparo = 'yes'";
        ...
        public void ListarLocais()
        {
            ...
            {
                string sql = "";
                sql += " Select Codigo, Quantidade, Posicao from Estoque where Codigo = '" + txtCodPeca.Text + "' and Posicao != 'PP' and Posicao not like '%KAM%' and Quantidade > '0'";
                cx.Conectar();
        ...
        public void Concluir()
        {
            ...
            //{
                ...
                {
                    string sql = "";
                    sql += " Insert into SaidaEstoque (Usuario, Codigo, Descricao, Quantidade, Tipo, Data, Hora, Cliente)";
                    sql += " Values ( ";
                    sql += " '" + Tecnico + "', ";
                    sql += " '" + txtCodPeca.Text + "', ";
        ...
        private void btnConcluir_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("DESEJA CONCLUIR?", "PERGUNTA", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                else
                {
                    ...
                    //{
                        consulta.comando = "";
                        consulta.comando = "update Estoque set Quantidade = Quantidade - '" + txtQntd.Text + "' where Codigo = '" + txtCodPeca.Text + "' and Posicao = '" + txtPosicao.Text + "'";
                        consulta.Atualizar();
        ...
        private void btnBusca_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        frmCadastrarClientes c = new frmCadastrarClientes(txtBusca.Text);
                        c.ShowDialog();
                        ListarClientes();
                        ListarClientesPorNome();
                    }
        ...
        public void consultarEstoque()
        {
            ...
            if ((txtParteDesc.Text.Length == 0) && (txtDescricao.Text.Length == 0))
            {
                ...
                sql = "select Codigo, Descricao, sum(Quantidade) As Quantidade from Estoque where Descricao like '%xxzzyy%' and Descricao like '%xxzzyy%' group by Codigo, Descricao order by Quantidade";
            ...
            else
            {
                ...
                sql = "select Codigo, Descricao, sum(Quantidade) As Quantidade from Estoque where Descricao like '%" + txtDescricao.Text + "%' and Descricao like '%" + txtParteDesc.Text + "%' group by Codigo, Descricao order by Quantidade";
