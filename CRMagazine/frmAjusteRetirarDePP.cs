...
namespace CRMagazine
{
    ...
    {
        public frmAjusteRetirarDePP(string texto)
        {
            InitializeComponent();
        ...
        public void ContadorDeProducao()
        {
            ...
            consulta.DataAtual();
            consulta.comando = "select COUNT(*) as QNT from Historico where Usuario = '" + lblUsuario.Text + "' and Status = '" + Local + "' and Data = '" + consulta.dataNormal + "'";
        ...
        {
            string sql = "";
            sql += " Select NS as SERIE, OS From Chamados where Status = '" + cboStatus.Text + "'";
            cx.Conectar();
        ...
        private void btnConcluir_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                consulta.comando = "";
                consulta.comando = "update Chamados set Status = '" + status + "' where OS = '" + txtOS.Text + "' AND STATUS = '" + cboStatus.Text + "'";
                consulta.Atualizar();
