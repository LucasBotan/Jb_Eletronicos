    ...
    public partial class frmReparoLancarRapido : Form
    {
        ...
        public void ContadorDeProducao()
        {
            if (cboUsuario.Text.Length > 0)
            {
                ...
                consulta.comando = "select COUNT(*) as QNT from Historico where Usuario = '" + cboUsuario.Text + "' and Status = '" + Status + "' and Data = '" + consulta.dataNormal + "'";
        ...
        public void AtualizarStatus()
        {
            ...
            if (consulta.Retorno == "ok")
            {
                ...
                consulta.InsereHistorico(txtOS.Text, cboUsuario.Text, StatusHistorico, consulta.dataNormal, consulta.hora);
                //=====fim da inserção======================================
            }         
        }
