    ...
    public partial class frmAlterarBanco : Form
    {
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (MessageBox.Show("DESEJA ALTERAR?", "PERGUNTA", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    //===========HISTORICO==================
                    consulta.comando = "";
                    consulta.comando = "update Historico set OS = '" + txtOS.Text + "' where OS = '" + OSOriginal + "'";
                    consulta.Atualizar();

                    /*
                    //===========AVARIAS====================
                    consulta.comando = "";
                    consulta.comando = "update Avarias set OS = '" + txtOS.Text + "' where OS = '" + OSOriginal + "'";
                    consulta.Atualizar();
                     */ 
        ...
        public void Alterar()
        {
            ...
            try
            {
                ...
                sql += " Where idChamados = " + txtID.Text;
                cx.Conectar();
                SqlCommand cd = new SqlCommand();
                cd.Connection = cx.c;
                cd.CommandText = sql;
