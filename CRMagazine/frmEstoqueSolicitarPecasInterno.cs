...
namespace CRMagazine
{
    public partial class frmEstoqueSolicitarPecasInterno : Form
    {
        ...
        public frmEstoqueSolicitarPecasInterno(string texto, string OS, string SKU, string Chamado, string Situacao)
        {
            InitializeComponent();
        ...
        public void concluirPedido()
        {
            ...
            if (txtNS.Text != "")
            {
                ...
                stringMontada = "Insert into Pedidos (Usuario, Codigo, Descricao, Quantidade, Status, HoraPedido, OS, NS, Situacao) Values ";
            ...
            {
                consultar.comando = "";
                consultar.comando = "Insert into Pedidos (Usuario, Codigo, Descricao, Quantidade, Status, HoraPedido, OS, NS, Situacao) Values ( ";
        ...
        private void lnkConsultarEstoqueSP_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                frmEstoqueSolicitarPecasSAOPAULO c = new frmEstoqueSolicitarPecasSAOPAULO(lblUsuario.Text, txtNS.Text, "", txtOS.Text, "BACKUP");
                c.ShowDialog();
                this.Close();
            }
