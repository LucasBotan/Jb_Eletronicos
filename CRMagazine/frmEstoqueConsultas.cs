...
namespace CRMagazine
{
    public partial class frmEstoqueConsultas : Form
    {
        ...
        {
            string sql = "";
            sql += " Select idCod, Codigo, Descricao, Quantidade, Posicao from Estoque";
            cx.Conectar();
        ...
        public void Listar()
        {
            ...
            {
                sql = "";
                sql += " Select idCod, Codigo, Descricao, Quantidade, Posicao from Estoque where " + opcao + " = '" + txtTexto.Text + "'";
            }
            else
            {
                sql = "";
                sql += " Select idCod, Codigo, Descricao, Quantidade, Posicao from Estoque where " + opcao + " like '%" + txtTexto.Text + "%'";
            }            
            cx.Conectar();
            SqlDataAdapter da = new SqlDataAdapter(sql, cx.c);
            DataSet ds = new DataSet();
        ...
        {
            string sql = "";
            string select = "select idCod, Codigo, Descricao, Quantidade, Posicao from Estoque where Codigo is not null ";
