...
namespace CRMagazine
{
    ...
    {
        public frmReparoDevolverPeca(string texto)
        {
            InitializeComponent();
            txtOS.Text = texto;
        }
        ...
        {
            string sql = "";
            sql += " Select idPedidos, OS, NS, Codigo, Descricao, Status, HoraPedido as 'Hora do Pedido' from Pedidos where OS = '" + txtOS.Text + "' and Status in ('RECEBIDO') order by HoraPedido";
            cx.Conectar();
